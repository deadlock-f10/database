    ...
    <div id="wrapper">
        ...
        <!-- Page Content -->
          <div id="page-wrapper">
			 <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">管理员类型设置</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
							...
							onclick="show('newadministrator.php')"><i class="fa  fa-plus-circle fa-fw"></i>新建管理员类型</button>							
							<button type="button" class="btn btn-outline btn-danger"
							onclick="show('offshelve.php')"><i class="fa  fa-minus-circle fa-fw"></i>删除管理员类型</button>						
                        </div>
                        <!-- /.panel-heading -->	
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										...
										$sql="select * from `administrator-level`";
